...
INSERT INTO `users` (`uid`, `username`, `password`, `hwid`, `admin`, `active`, `banned`, `invitedBy`, `createdAt`) VALUES
(1, 'admin', '$2y$10$X3K9Vm/RBWfTl.drTi4//OtiyB.s9uaRmia0q2sLzjaET.im3sfvu', NULL, 1, 1, 0, '', '2020-10-20 08:29:37');
COMMIT;
